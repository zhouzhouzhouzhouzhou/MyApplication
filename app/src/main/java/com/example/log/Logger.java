...
import com.example.wgcommon.AppExecutors;
...
//    private static final String MIDDLE_BORDER = MIDDLE_CORNER + SINGLE_DIVIDER + SINGLE_DIVIDER;
    ...
    public boolean trace(int traceLevel, String logPath) {
    ...
    private int eAll(String tag, String msg){
    ...
    private int println(final int priority, final String tag, final String msg) {
        if (priority < level || failCount >= 5 || logWriter == null) {
            return 0;
        }

        AppExecutors.rxJavaIOExecute(new Runnable() {
            @Override
            public void run() {
                toPrint(priority, tag, msg);
            }
        });
        return 0;
    }

    private void toPrint(int priority, String tag, String msg) {
